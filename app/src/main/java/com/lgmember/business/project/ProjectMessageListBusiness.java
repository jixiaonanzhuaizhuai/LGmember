...
public class ProjectMessageListBusiness {
    ...
    public void getAlreadJoinList() {
        ...
        projectMessageImpl.getAlreadJoinList(pageNo,pageSize,handler,context);
    }
    public void getSoonJoinList() {
        // TODO 可能还要验证密码
        // 登陆
        projectMessageImpl = new ProjectMessageImpl();
        projectMessageImpl.getSoonJoinList(pageNo,pageSize,handler,context);
    }
    ...
    public void getHotProjectMessage() {
        ...
        // 登陆
        projectMessageImpl = new ProjectMessageImpl();
        projectMessageImpl.getHotList(pageNo,pageSize,handler,context);
    }
