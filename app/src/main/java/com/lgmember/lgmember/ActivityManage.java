...
public class ActivityManage extends FragmentActivity {
	...
	private Class fragmentArray[] = {
			FragmentAlreadyJoin.class, FragmentSoonJoin.class,FragmentHot.class, FragmentActivityList.class};

	// 定义数组来存放按钮图片
	private int mImageViewArray[] = { R.drawable.manage_tab_item_alreadyjoin,
			R.drawable.manage_tab_item_soonjoin,R.drawable.manage_tab_item_hot,
	...
	private void initView() {
		...
		mTabHost.setup(ActivityManage.this, getSupportFragmentManager(), R.id.realtabcontent);
