...
public class CertificationImpl extends HttpApi {
    ...
    public void certificationMsg(Certification certification, final CertificationBusiness.CertificationResulHandler handler, Context context) {
        ...
        Log.i("---6666---",certification.getName()+certification.getIdno()+certification.getGender()+certification.getNation()+" "+
                certification.getUpload_session_id());
