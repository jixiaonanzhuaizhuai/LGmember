...
public class MyMessageActivity extends FragmentActivity implements TopBarView.onTitleBarClickListener {
	...
	private Class fragmentArray[] = {
			SystemMessageActivity.class, MemberMessageActivity.class};
	...
	// Tab选项卡的文字
	private String mTextviewArray[] = { "系统消息", "会员消息"};
	...
	private void initView() {
		...
		mTabHost.setup(MyMessageActivity.this, getSupportFragmentManager(),
				R.id.realtabcontent);
